...
%\resheading{Summary}
%\begin{description}[style=unboxed,leftmargin=0.2cm]
%\item Senior Software Engineer with expertise in backend development, distributed systems, and cloud solutions. Proven track record of leading teams, optimizing processes, and delivering scalable fintech and cloud applications.
%\end{description}
